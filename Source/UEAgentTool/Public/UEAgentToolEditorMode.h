...
#include "UEAgentToolEditorMode.generated.h"
 ...
 */
UCLASS()
class UUEAgentToolEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_UEAgentToolEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UUEAgentToolEditorMode();
	virtual ~UUEAgentToolEditorMode();
