...
#include "UEAgentToolInteractiveTool.generated.h"


/**
 * Builder for UUEAgentToolInteractiveTool
 */
UCLASS()
class UEAGENTTOOL_API UUEAgentToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UUEAgentToolInteractiveTool
 */
UCLASS(Transient)
class UEAGENTTOOL_API UUEAgentToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UUEAgentToolInteractiveToolProperties();
...
/**
 * UUEAgentToolInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class UEAGENTTOOL_API UUEAgentToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UUEAgentToolInteractiveToolProperties> Properties;
