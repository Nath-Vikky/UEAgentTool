...
#include "UEAgentToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UUEAgentToolInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UUEAgentToolInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UUEAgentToolInteractiveTool* NewTool = NewObject<UUEAgentToolInteractiveTool>(SceneState.ToolManager);
...
UUEAgentToolInteractiveToolProperties::UUEAgentToolInteractiveToolProperties()
{
...
void UUEAgentToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UUEAgentToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UUEAgentToolInteractiveToolProperties>(this, "Measurement");
...
void UUEAgentToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UUEAgentToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UUEAgentToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UUEAgentToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UUEAgentToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UUEAgentToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UUEAgentToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UUEAgentToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UUEAgentToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
